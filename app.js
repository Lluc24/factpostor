...
(() => {
  ...
  function initializeEventListeners() {
    ...
    byId("player-input").addEventListener("keypress", (e) => {
  ...
  function renderRoundContent(container, content) {
    container.innerHTML = "";
    ...
    if (content.type === "fact") {
      ...
      container.appendChild(window.FactpostorImages.createPhotoElement(
        ...
        i18n.localize(content.fact.text),
        viewSourceText,
        unavailableText
      ));
      return;
    ...
    if (content.type === "secret") {
      ...
      container.appendChild(window.FactpostorImages.createPhotoElement(
        content.item.wikiTitle,
        i18n.localize(content.item.name),
        viewSourceText,
        unavailableText
      ));
      return;
  ...
  function resetGame() {
    ...
    byId("player-input").value = "";
    byId("impostor-count").value = "auto";
    updatePlayerList();
    updateStartButton();
    selectMode("facts");
